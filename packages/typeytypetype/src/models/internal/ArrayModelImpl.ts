...
export class ArrayModelImpl<TElement> extends ModelImpl<TElement[], ArrayDefinition<TElement>> implements ArrayModelParts<TElement>{
    constructor(value: TElement[], definition: ArrayDefinition<TElement>, originalDefinition: Definition<TElement[]>, depth: number, factory: ModelFactory) {
    ...
    async spliceElements(start: number, deleteCount: number, newElements: TElement[]): Promise<Model<TElement[]>> {
